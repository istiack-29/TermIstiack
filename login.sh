...
# Theme Generation (YYYY-MM-DD format & 24h Time)
...
# Background notification hidden
unsetopt MONITOR

# Auto update in background
( cd \$HOME/TermIstiack && git fetch &>/dev/null && git pull &>/dev/null ) &

clear
# Login Lock Screen Art
echo -e "\e[1;32m      
░▒▓█▓▒░      ░▒▓██████▓▒░ ░▒▓██████▓▒░░▒▓█▓▒░▒▓███████▓▒░  
░▒▓█▓▒░     ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
░▒▓█▓▒░     ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░      ░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
